...
- Different between command and process substitution is that the later will place the output in a temporary file
...
- Thus, functions can modify environment variables whereas scripts cant
