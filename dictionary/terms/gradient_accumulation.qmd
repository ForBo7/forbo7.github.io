...
description: "A technique for running or fitting large models on a not-so-powerful GPU."
---
...
1. Calculate the gradients for $X$ batches without updating the parameters.
...
1. Next, sum all respective gradients — hence the term 'gradient accumulation'.
1. Now update your parameters based on these summed gradients. This will have the same effect as if you used a batch size of 64.
