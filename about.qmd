...
I have a very particular manner and philosophy to programming. It's expository programming: literate, exploratory, and the way it should be done. See [here](https://docs.fast.ai/dev/style.html), [here](https://archive.vector.org.uk/art10000980), and [here](https://nbdev.fast.ai/). Writing code is not the focus, solving the problem at hand is.
