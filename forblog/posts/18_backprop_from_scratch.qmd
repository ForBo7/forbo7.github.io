...
This post would not be possible if not for the elegant deconstruction of backpropagation in fastai Course Part 2 taught by [Jeremy Howard](https://solve.it.com/#im-jeremy-howard-from-fastai), and for the elegant deconstruction also present in [The Matrix Calculus You Need for Deep Learning] by [Terence Parr](https://www.linkedin.com/in/terence-parr/) and also Jeremy Howard.
:::
